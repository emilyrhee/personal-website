<script lang="ts">
  import Bolts from "./Bolts.svelte";
</script>

<div class="relative bg-light-brown text-lg text-beige font-jetbrains p-12 rounded">
  <Bolts />
  
  <h2 class="text-beige text-4xl font-coiny">GPT</h2>
